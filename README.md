# recteurlp/gitlab-ci-multi-runner-fedora:1.10.4
...
```bash
docker pull recteurlp/gitlab-ci-multi-runner-fedora:1.10.4
```
...
docker run --name gitlab-ci-multi-runner-fedora -it --rm \
  --volume /opt/gitlab-ci-multi-runner-fedora:/home/gitlab_ci_multi_runner/data \
  recteurlp/gitlab-ci-multi-runner-fedora:1.10.4 --help
```
...
```
FROM recteurlp/gitlab-ci-multi-runner-fedora:1.10.4
