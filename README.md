# recteurlp/gitlab-ci-multi-runner-fedora:1.10.3
...
```bash
docker pull recteurlp/gitlab-ci-multi-runner-fedora:1.10.3
```
...
docker run --name gitlab-ci-multi-runner-fedora -it --rm \
  --volume /opt/gitlab-ci-multi-runner-fedora:/home/gitlab_ci_multi_runner/data \
  recteurlp/gitlab-ci-multi-runner-fedora:1.10.3 --help
```
...
```
FROM recteurlp/gitlab-ci-multi-runner-fedora:1.10.3
