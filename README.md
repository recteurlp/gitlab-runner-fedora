# recteurlp/gitlab-ci-multi-runner-fedora:0.7.2
...
```bash
docker pull recteurlp/gitlab-ci-multi-runner-fedora:0.7.2
```
...
docker run --name gitlab-ci-multi-runner-fedora -it --rm \
  --volume /opt/gitlab-ci-multi-runner-fedora:/home/gitlab_ci_multi_runner/data \
  recteurlp/gitlab-ci-multi-runner-fedora:0.7.2 --help
```
...
```
FROM recteurlp/gitlab-ci-multi-runner-fedora:0.7.2
