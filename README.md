# recteurlp/gitlab-runner-fedora:11.5.1
...
```bash
docker pull recteurlp/gitlab-runner-fedora:11.5.1
```
...
docker run --name gitlab-runner-fedora -it --rm \
  --volume /opt/gitlab-runner-fedora:/home/gitlab_runner/data \
  recteurlp/gitlab-runner-fedora:11.5.1 --help
```
...
```
FROM recteurlp/gitlab-runner-fedora:11.5.1
