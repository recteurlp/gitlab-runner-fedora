# pyrmin.io/gitlab-runner-fedora:11.11.2
...
```bash
docker pull pyrmin.io/gitlab-runner-fedora:11.11.2
```
...
docker run --name gitlab-runner-fedora -it --rm \
  --volume /opt/gitlab-runner-fedora:/home/gitlab_runner/data \
  pyrmin.io/gitlab-runner-fedora:11.11.2 --help
```
...
```
FROM pyrmin.io/gitlab-runner-fedora:11.11.2
