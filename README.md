# recteurlp/gitlab-runner-fedora:10.2.0
...
```bash
docker pull recteurlp/gitlab-runner-fedora:10.2.0
```
...
docker run --name gitlab-runner-fedora -it --rm \
  --volume /opt/gitlab-runner-fedora:/home/gitlab_runner/data \
  recteurlp/gitlab-runner-fedora:10.2.0 --help
```
...
```
FROM recteurlp/gitlab-runner-fedora:10.2.0
